...
class UserService:
    ...
    async def register_user(user_data: UserRegistration) -> User:
        ...
        Регистрация проходит валидацию:
        - Создание пароля: 8 символов, только латиница, минимум 1 символ верхнего регистра, минимум 1 спец символ $%&!:.
        - Телефон должен удовлетворять маске: начинаться с +7 после чего идет 10 цифр.
        - Телефон и e-mail: уникальные значения.
